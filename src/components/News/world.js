...
const World = ({ newsData, page, rowsPerPage, selected, toggle, timeConversion, articleComments}) => {
    return (
                            ...
                            <div className="container-fluid" id="news_box">
                                <div className="row news_card" key={`news-${i}`}>
                                    ...
                                    <div className="col-lg-8 col-md-7 news_content_col">
                                        <h4 className="news_title">{ news_info.headline ? news_info.headline.main : news_info.title }</h4>
